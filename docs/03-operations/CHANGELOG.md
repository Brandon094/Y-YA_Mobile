...
- **Versión de Lanzamiento Oficial (SENA Gold Edition):**
    ...
    - Mitigación de vulnerabilidades reportadas por Dependabot (v0.1.3 -> v1.0.0), incluyendo parches críticos para **Netty HTTP/2 DoS** (CVE-2024-29025) y **Apache HttpClient** (CVE-2020-13956).
