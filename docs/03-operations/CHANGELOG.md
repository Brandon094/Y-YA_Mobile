...
- **Versión de Lanzamiento Oficial (SENA Gold Edition):**
    ...
    - Mitigación de vulnerabilidades reportadas por Dependabot (v0.1.3 -> v1.0.0), incluyendo parches críticos para **Netty** (DoS y SslHandler Crash), **Apache HttpClient** (CVE-2020-13956) y **Bouncy Castle** (CVE-2024-34447).
